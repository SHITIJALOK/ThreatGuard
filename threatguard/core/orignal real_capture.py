...
class RealCaptureThread(QThread):
    ...
    def _infer_fallback_threat(
        ...
        # Ignore normal encrypted traffic
        ...
        if flow_rec.protocol == 6:
            ...
            # Real HTTP DoS only
            if (
                flow_rec.dst_port in [80, 8000]
                and total_pkts >= 120
                and pps >= 180
                and flow_rec.syn_count >= 10
            ):
                return ThreatType.DOS_ATTACK
        ...
        if (
            ...
            and flow_rec.dst_port != 53
            and (pps >= 500 or total_pkts >= 250)
        ):
            return ThreatType.DOS_ATTACK
